...
const STORE_LOCATIONS = [
  {
    id: "marion-road",
    name: "Marion Road, West Richmond",
    address:
  ...
  },
  {
    ...
    name: "Walkerville",
    address:
      "2/117 Walkerville Terrace, Walkerville SA 5081",
  },
];
...
export default function Booking() {
  ...
  const timeSlots = useMemo(
    () =>
      isWeekend(form.appointmentDate)
        ? WEEKEND_SLOTS
        : WEEKDAY_SLOTS,
  ...
  const selectedStore = STORE_LOCATIONS.find(
    (store) =>
      store.id === form.storeLocation
  );

  /*
   * Check booked slots based on:
   *
   * DATE + SELECTED STORE
   *
  ...
  const handleSubmit = async (
    ...
    if (!form.serviceType) {
      toast({
        ...
        description:
          "Please choose the type of service you need.",
        variant: "destructive",
      });
    ...
    if (
      ...
      toast({
        ...
        description:
          "Please choose which store you would like to visit.",
        variant: "destructive",
      });
    ...
    if (
      ...
      !form.remoteLocation.trim()
    ) {
      toast({
        title: "Location Required",
        description:
          "Please enter your preferred location for the remote appointment.",
        variant: "destructive",
      });
    ...
    try {
      /*
       * Save the selected store address in
       * remote_location for store appointments.
       */
    ...
    return (
      <div className="w-full">
        <section className="relative h-48 bg-primary flex items-center justify-center">
          <h1 className="font-display text-3xl sm:text-5xl text-white font-bold relative z-10">
            Book a Fitting
          </h1>
        </section>
        ...
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-muted-foreground mb-10 text-sm">
            {form.locationType ===
            "store"
              ? `We look forward to seeing you at ${selectedStore?.address}.`
    ...
    <div className="w-full">
      <section className="relative h-48 bg-primary flex items-center justify-center">
        <div className="absolute inset-0 overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1540569014015-19a7be504e3a?q=80&w=1800&auto=format&fit=crop"
            alt="Booking hero"
        ...
        <div className="relative z-10 text-center">
          <h1 className="font-display text-3xl sm:text-5xl text-white font-bold">
            Book a Fitting
          </h1>
      ...
      <section className="py-16 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="bg-card rounded-2xl border border-border p-5 sm:p-8">
            ...
            <p className="text-muted-foreground text-sm mb-5">
              Visit us in store or we can come to you
            </p>
            ...
            {form.locationType ===
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="e.g. 42 Example Street, Norwood SA 5067"
                  className="mt-2"
                />

                <p className="text-xs text-muted-foreground mt-1.5">
                  Please provide a full
                  address where you'd like
                  us to visit.
                </p>
              </div>
            )}
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1 mb-3">
                  {isWeekend(
                    ...
                    ? "Weekend hours: 10:00 AM – 5:00 PM"
                    : "Weekday hours: 12:00 PM – 7:00 PM"}
                </p>
          ...
          <div className="bg-card rounded-2xl border border-border p-5 sm:p-8">
            ...
            <p className="text-muted-foreground text-sm mb-5">
              Tell us anything that will help
              us prepare for your appointment
            </p>
            ...
            <Textarea
              ...
              placeholder="e.g. Occasion, style preferences, fabric ideas, special requirements..."
            />
          </div>
